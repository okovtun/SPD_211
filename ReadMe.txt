...
TODO:
1. Добавить в геометрическую фигуру цвет и ее координаты на экране;	DONE
2. Создать класс Circle, описывающий круг;							DONE
3. Создать класс треугольник;										DONE
4. *Создать ветку 'AbstractGeometryDrawOptimisation', и вынести основной код метода draw() в базовый класс
	(Для этого нужны указатели на функцию)
